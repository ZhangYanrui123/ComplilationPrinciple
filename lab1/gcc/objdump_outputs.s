...
factorials.o:     file format elf64-x86-64
...
0000000000001100 <main>:
    ...
    1108:	48 8d 3d 51 30 00 00 	lea    0x3051(%rip),%rdi        # 4160 <_ZSt3cin@@GLIBCXX_3.4>
    110f:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    1116:	00 00 
    1118:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    111d:	31 c0                	xor    %eax,%eax
    111f:	48 8d 74 24 04       	lea    0x4(%rsp),%rsi
    1124:	e8 87 ff ff ff       	callq  10b0 <_ZNSirsERi@plt>
    1129:	8b 54 24 04          	mov    0x4(%rsp),%edx
    112d:	be 01 00 00 00       	mov    $0x1,%esi
    1132:	b8 02 00 00 00       	mov    $0x2,%eax
    1137:	39 c2                	cmp    %eax,%edx
    1139:	7c 07                	jl     1142 <main+0x42>
    113b:	0f af f0             	imul   %eax,%esi
    113e:	ff c0                	inc    %eax
    1140:	eb f5                	jmp    1137 <main+0x37>
    1142:	48 8d 3d f7 2e 00 00 	lea    0x2ef7(%rip),%rdi        # 4040 <_ZSt4cout@@GLIBCXX_3.4>
    1149:	e8 a2 ff ff ff       	callq  10f0 <_ZNSolsEi@plt>
    114e:	48 89 c7             	mov    %rax,%rdi
    1151:	e8 4a ff ff ff       	callq  10a0 <_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_@plt>
    1156:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    115b:	64 48 33 04 25 28 00 	xor    %fs:0x28,%rax
    1162:	00 00 
    1164:	74 05                	je     116b <main+0x6b>
    1166:	e8 65 ff ff ff       	callq  10d0 <__stack_chk_fail@plt>
    116b:	31 c0                	xor    %eax,%eax
    116d:	48 83 c4 18          	add    $0x18,%rsp
    1171:	c3                   	retq   

0000000000001172 <_GLOBAL__sub_I_main>:
    1172:	f3 0f 1e fa          	endbr64 
    1176:	50                   	push   %rax
    1177:	48 8d 3d fb 30 00 00 	lea    0x30fb(%rip),%rdi        # 4279 <_ZStL8__ioinit>
    117e:	e8 5d ff ff ff       	callq  10e0 <_ZNSt8ios_base4InitC1Ev@plt>
    1183:	48 8b 3d 6e 2e 00 00 	mov    0x2e6e(%rip),%rdi        # 3ff8 <_ZNSt8ios_base4InitD1Ev@GLIBCXX_3.4>
    118a:	59                   	pop    %rcx
    118b:	48 8d 15 76 2e 00 00 	lea    0x2e76(%rip),%rdx        # 4008 <__dso_handle>
    1192:	48 8d 35 e0 30 00 00 	lea    0x30e0(%rip),%rsi        # 4279 <_ZStL8__ioinit>
    1199:	e9 22 ff ff ff       	jmpq   10c0 <__cxa_atexit@plt>
...
0000000000001240 <__do_global_dtors_aux>:
    ...
    1244:	80 3d 2d 30 00 00 00 	cmpb   $0x0,0x302d(%rip)        # 4278 <completed.8061>
    ...
    126c:	c6 05 05 30 00 00 01 	movb   $0x1,0x3005(%rip)        # 4278 <completed.8061>
    1273:	5d                   	pop    %rbp
    1274:	c3                   	retq   
...
0000000000001290 <__libc_csu_init>:
    ...
    1294:	41 57                	push   %r15
    1296:	4c 8d 3d d3 2a 00 00 	lea    0x2ad3(%rip),%r15        # 3d70 <__frame_dummy_init_array_entry>
    129d:	41 56                	push   %r14
    ...
    12ac:	55                   	push   %rbp
    12ad:	48 8d 2d cc 2a 00 00 	lea    0x2acc(%rip),%rbp        # 3d80 <__do_global_dtors_aux_fini_array_entry>
    12b4:	53                   	push   %rbx
